...
airplane=createSprite(spider.position.x, 200, 10, 10)
...
if(vidan2===0){
  guradia2Group.destroyEach();
        ...
        text("Vida:", camera.position.x+220, camera.position.y-200)
        ...
        if(spider.isTouching(laserGroup) || spider.isTouching(lavaGroup) || spider.isTouching(puasGroup) || spider.isTouching(pirañaGroup)){
          ...
          spider.velocityY=0
          vidas-=1
anunciovida=createSprite(spider.position.x+400, camera.position.y/2+110, 40, 40)
